...
const { checkName, checkPrice } = require("../validations/checkFood.js");
...
foods.post("/", checkName, checkPrice, async (req, res) => {
  const body = req.body;
...
foods.put("/:id", checkName, checkPrice, async (req, res) => {
  const id = Number(req.params.id);
  const body = req.body;
