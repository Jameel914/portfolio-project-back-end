...
const {
  ...
  checkPrice,
  checkIsSpicy,
} = require("../validations/checkFood.js");
...
foods.post("/", checkName, checkPrice, checkIsSpicy, async (req, res) => {
  const body = req.body;
...
foods.put("/:id", checkName, checkPrice, checkIsSpicy, async (req, res) => {
  const id = Number(req.params.id);
  const body = req.body;
